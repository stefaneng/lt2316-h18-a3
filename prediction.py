...
class PredictiveSearch:
    ...
    def __init__(self, modelfile, tokenizerfile, encoded_images):
        '''
    ...
    def predictive_search(self, words):
        ...
        # Encode the sequence using the tokenizer used in training
        ...
        # Predict the word and vector representation of the image
        ...
        # Display the nearest 3 images to the vector prediction
